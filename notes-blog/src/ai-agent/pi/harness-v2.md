...
> **英文原文：** [`earendil-works/pi` — Durable AgentHarness design](https://github.com/earendil-works/pi/blob/harness-v2/j4/packages/agent/docs/harness-v2.md?plain=1)
>
> 本文是上述 Harness v2 设计文档的完整中文翻译。代码、类型名、字段名、命令、路径和协议值保持原样，便于按需返回原文自行对照。
