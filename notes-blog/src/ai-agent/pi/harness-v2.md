# AgentHarness v2：英文原文 / 中文逐段对照

<div class="translation-note">

本页严格按照原文顺序交错展示：每个英文标题、段落、列表、表格或代码块之后，紧跟对应中文译文。代码与协议标识保持原样；表格以完整表格为一个对照单元。

- [单独阅读英文原文](../../sources/harness-v2.en.md)
- [单独阅读完整中文译文](harness-v2-zh.md)
- [原始 GitHub 文档](https://github.com/earendil-works/pi/blob/harness-v2/j4/packages/agent/docs/harness-v2.md?plain=1)

</div>

<div class="bilingual-marker bilingual-marker-en">English original · 001 · heading</div>

# Durable AgentHarness design

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 001</div>

# 可持久恢复的 AgentHarness 设计

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 002 · quote</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 002</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 003 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 003</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 004 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 004</div>

Harness 每次针对一个会话执行 run。会话保存四类状态（第 2 节）；同一个 Harness 内的多个 lane 可以并行执行（第 3 节）；存储后端负责对会话进行编码（第三部分）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 005 · heading</div>

# Part I — Concepts

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 005</div>

# 第一部分——概念

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 006 · heading</div>

## 1. Goals

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 006</div>

## 1. 目标

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 007 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 007</div>

- **可持久恢复的 run。** 一个已经被接受的 prompt 是一项持久化操作。进程崩溃后，新进程会还原会话，并从上一个安全边界恢复执行该 run。崩溃可能产生的每一种状态都必须能够恢复。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 008 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 008</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 009 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 009</div>

- **不存在半成品结果。** 在任何操作——run、压缩或导航——内部发生崩溃后，只允许留下两种状态之一：该操作尚未发生，或者恢复流程能够将它完成。外部不能观察到介于两者之间的状态。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 010 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 010</div>

- **Harness API。** 事件（event）只能观察执行过程，不能改变执行；钩子（hook）会拦截执行并可以修改上下文、请求、工具和 run 边界。扩展建立在事件与钩子之上。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 011 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 011</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 012 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 012</div>

- **可观测性。** 所有执行过程都可被日志和 tracing 检测，粒度可深入到 Provider 请求与响应的内部。该通道与钩子系统相互独立。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 013 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 013</div>

- **UI 模型。** 客户端先获得一份原子快照，随后接收实时事件流。事件不会重放；重新连接意味着获取一份新快照。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 014 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 014</div>

- **单写者。** 同一时间只有一个 Harness 写入某个会话，由服务层强制保证。一个会话的所有 lane 都位于这一个 Harness 中。还原时，如果遇到单写者模型不可能产生的状态，就将其视为数据损坏。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 015 · list_item</div>

- **v3 sessions load.** Old coding-agent v3 JSONL files open unchanged and restore idle.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 015</div>

- **能够加载 v3 会话。** 旧版 coding-agent v3 JSONL 文件无需改动即可打开，并还原为空闲状态。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 016 · heading</div>

## Non-goals

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 016</div>

## 非目标

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 017 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 017</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 018 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 018</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 019 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 019</div>

- **多写者。** 两个进程同时操作同一会话不在范围内。服务层会把某个会话的全部流量路由到持有其 Harness 的进程。lane 可以承载那些看起来像多写者的工作负载：在共享历史之上的多个并行 thread。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 020 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 020</div>

- **复制。** 一个会话只存在于一个位置。无需协调地同步已经产生分歧的副本属于另一套设计；本设计也没有阻止未来增加它。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 021 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 021</div>

- **迁移 coding-agent。** 将 coding-agent 迁移到 `AgentHarness` 不在范围内。这里的兼容仅表示新的 JSONL repository 可以读取受支持的 coding-agent v3 文件。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 022 · heading</div>

## 2. What a session is

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 022</div>

## 2. 会话是什么

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 023 · paragraph</div>

A session is durable state with four parts:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 023</div>

会话是一组由四部分构成的持久状态：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 024 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 024</div>

1. **树（tree）**——对话本身。条目通过 `parentId` 相连，包括消息、模型/思考级别/工具激活状态的变化、压缩摘要、分支摘要以及自定义条目。树是共享且被动的，不归任何 lane 独占。它只会增长；条目从不修改或删除。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 025 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 025</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 026 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 026</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 027 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 027</div>

4. **全局事实（global facts）**——会话范围内“最新写入获胜”的值，例如会话名称和条目标签。它们不属于对话树，按只追加历史保存，读取者看到最新值。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 028 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 028</div>

这四部分的所有写入共享同一个单调递增序列号。该序列既用于排列全局事实的历史，也让 lane 操作日志能够引用树中的位置。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 029 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 029</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 030 · heading</div>

### Active and passive

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 030</div>

### 主动与被动

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 031 · paragraph</div>

The tree and the global facts are passive: shared data, readable by anything.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 031</div>

树和全局事实是被动数据：它们由各方共享，任何组件都可以读取。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 032 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 032</div>

lane 是主动的。它拥有自己的叶节点、操作日志（至多一项打开的操作）、队列以及待处理写入。两个 lane 绝不共享这些内容。lane 的每个动作，要么生成链接到其叶节点的新条目，要么在自己的操作日志中生成记录。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 033 · heading</div>

### Invariants

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 033</div>

### 不变量

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 034 · list_item</div>

- The tree is conversation only. No lane state, no orchestration state, no pointers live in it.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 034</div>

- 树只包含对话。lane 状态、编排状态和指针都不能放进树中。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 035 · list_item</div>

- An entry's parent chain never changes. Branches share prefixes; nothing is copied.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 035</div>

- 条目的父链永不改变。不同分支共享前缀，不复制内容。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 036 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 036</div>

- lane 的叶节点只有两种移动方式：lane 追加条目（该条目成为新叶节点），或者 lane 执行导航（叶节点跳到已有条目）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 037 · list_item</div>

- Operation-log records never affect the tree. Deleting every operation log leaves a complete, valid conversation.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 037</div>

- 操作日志记录绝不影响树。即使删除全部操作日志，剩下的仍是一段完整、有效的对话。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 038 · list_item</div>

- At most one operation is open per lane. A state where one lane has two open operations is corruption.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 038</div>

- 每个 lane 至多打开一项操作。如果同一 lane 同时存在两项打开的操作，说明数据已损坏。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 039 · list_item</div>

- Entries are shared; records are not. Two lanes may have the same entry on their paths. A record belongs to exactly one lane.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 039</div>

- 条目可以共享，记录不能共享。两个 lane 的路径上可以出现同一条目；一条记录只属于一个 lane。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 040 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 040</div>

记录不是树条目，因为记录描述的是执行过程，而不是对话。它绝不能进入模型上下文、transcript、分支查询或 fork；而且在一个 lane 内，记录的先后顺序本身就表达了含义，增加父链接没有价值。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 041 · heading</div>

## 3. Lanes

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 041</div>

## 3. Lane

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 042 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 042</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 043 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 043</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 044 · paragraph</div>

A lane owns:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 044</div>

一个 lane 拥有：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 045 · list_item</div>

- **Its leaf.** New entries chain to it and move it. Navigation jumps it.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 045</div>

- **自己的叶节点。** 新条目链接到它，并推动它前进；导航则让它跳转。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 046 · list_item</div>

- **Its operation log.** At most one open operation. A second operation on a busy lane is rejected; other lanes are unaffected.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 046</div>

- **自己的操作日志。** 至多有一项打开的操作。向繁忙 lane 提交第二项操作会被拒绝，不影响其他 lane。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 047 · list_item</div>

- **Its queues.** Steering, follow-ups, and next-run messages target one lane.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 047</div>

- **自己的队列。** steering、follow-up 和 next-run 消息都以一个 lane 为目标。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 048 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 048</div>

- **自己的配置视图。** 模型、思考级别和已激活工具，都由 lane 叶节点之前路径上的条目决定。两个 lane 可以使用不同模型，彼此无需感知。工具实现、资源和流选项属于整个 Harness；只有工具是否激活是每个 lane 独立的。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 049 · paragraph</div>

Rules:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 049</div>

规则如下：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 050 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 050</div>

- 不同 lane 并行运行操作。Harness 仍是唯一写者；各 lane 的记录和条目会交错进入共享序列。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 051 · list_item</div>

- Creating a lane copies nothing. Lanes are not deleted or renamed.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 051</div>

- 创建 lane 不会复制任何内容。lane 不会被删除或重命名。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 052 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 052</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 053 · list_item</div>

- Two lanes at the same leaf diverge on their next append. The tree handles this; no coordination exists between lanes.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 053</div>

- 位于同一叶节点的两个 lane，会在下一次追加时分叉。树天然处理这种情况，不需要任何协调。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 054 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 054</div>

- 如果某个 lane 有未完成操作，它会独立于其他 lane 被还原为 suspended（已挂起）状态。挂起原因可能是崩溃，也可能是延迟 Provider 请求（第 1 节）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 055 · heading</div>

## 4. How work executes

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 055</div>

## 4. 工作如何执行

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 056 · heading</div>

### Operations

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 056</div>

### 操作

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 057 · paragraph</div>

An operation is the unit of durable work on a lane. Three kinds:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 057</div>

操作是 lane 上可持久恢复的工作单元，共有三种：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 058 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 058</div>

- **Run**——从一个已接受的 prompt 开始，包括全部自动后续过程：工具调用、steering、follow-up 和自动压缩。在没有任何待处理工作时结束。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 059 · list_item</div>

- **Compaction** — replaces old context with a summary entry.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 059</div>

- **压缩（compaction）**——用一个摘要条目替换旧上下文。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 060 · list_item</div>

- **Navigation** — moves the lane's leaf to an existing entry, optionally with a branch summary.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 060</div>

- **导航（navigation）**——把 lane 的叶节点移到已有条目，并可选择生成分支摘要。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 061 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 061</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 062 · heading</div>

### Runs, turns, and steps

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 062</div>

### Run、turn 与 step

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 063 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 063</div>

一个 run 是一系列 turn。一个 turn 由一次 assistant step，以及该 assistant 消息请求的完整工具批次组成。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 064 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 064</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 065 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 065</div>

每个真正启动副作用的工具调用同样是一个 step。`tool_started` 将它打开，工具结果条目将它闭合。并行批次可以同时持有多个打开的工具 step；这些副作用并发执行，但按照它们在原消息中的顺序完成持久化（第 14 节）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 066 · heading</div>

### Queues and deferred writes

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 066</div>

### 队列与延迟写入

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 067 · paragraph</div>

Two mechanisms carry input into a running lane. They differ in abort behavior:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 067</div>

有两种机制可以向正在运行的 lane 传入输入，它们在 abort 时的行为不同：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 068 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 068</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 069 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 069</div>

- **延迟写入**承载事实：某个 step 执行期间请求写入的条目或配置变更。它们能跨越 abort 存活，即使处于取消流程中也会应用。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 070 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 070</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 071 · heading</div>

### Checkpoints

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 071</div>

### 检查点

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 072 · paragraph</div>

Between turns, the lane passes a checkpoint:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 072</div>

每两个 turn 之间，lane 会经过一个检查点：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 073 · list_item</div>

1. Apply pending deferred writes.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 073</div>

1. 应用待处理的延迟写入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 074 · list_item</div>

2. Consume queued steering messages.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 074</div>

2. 消费队列中的 steering 消息。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 075 · list_item</div>

3. Compact if the next request would not fit.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 075</div>

3. 如果下一个请求放不进上下文，则执行压缩。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 076 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 076</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 077 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 077</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 078 · heading</div>

### Append-only context

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 078</div>

### 只在尾部追加的上下文

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 079 · quote</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 079</div>

> 在一个 lane 的连续请求之间，Provider 上下文只能从尾部增长。如果在上次请求尾部之前插入内容，Provider 的 KV cache 会从插入点起失效，从而成倍增加 token 成本。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 080 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 080</div>

这项不变量解释了为何 turn 中途发生的写入要延迟到检查点：检查点总是在尾部追加。压缩是唯一有意设计的例外；它用一次完整的缓存失效换取更短的上下文。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 081 · heading</div>

### Lane lifecycle

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 081</div>

### Lane 生命周期

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 082 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 082</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 083 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 083</div>

- 状态以 lane 为单位。唯一例外是存储写入失败会使整个 Harness 进入 faulted 状态。处于 faulted 状态的 Harness 会停止所有副作用并拒绝所有调用；问题修复后，重新打开会从记录中还原每个 lane。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 084 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 084</div>

- **Suspended（已挂起）**表示一项操作仍然打开，但当前没有任何执行。它可能来自崩溃后的还原，也可能是在延迟 handle 持久化后主动进入。`resume()` 继续该操作；`abort()` 不执行后续正常工作，直接将它关闭。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 085 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 085</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 086 · heading</div>

### Resume

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 086</div>

### 恢复执行

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 087 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 087</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 088 · heading</div>

# Part II — How execution is recorded

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 088</div>

# 第二部分——如何记录执行过程

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 089 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 089</div>

第二部分与具体后端无关。它定义 lane 写入哪些记录、何时写入，以及恢复流程如何读回这些记录。第三部分再把这些规则映射到 API 和存储实现。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 090 · heading</div>

## 5. Records

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 090</div>

## 5. 记录

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 091 · heading</div>

### The durability rule

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 091</div>

### 持久化规则

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 092 · quote</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 092</div>

> 在产生副作用之前：先写一条意图记录，说明将发生什么，以及它会产生哪些 ID。副作用完成后：使用完全相同的 ID，把结果追加为一个条目。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 093 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 093</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 094 · heading</div>

### Provisioned ids

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 094</div>

### 预分配 ID

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 095 · paragraph</div>

Intent records carry the ids of entries that do not exist yet:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 095</div>

意图记录会携带尚不存在的条目 ID：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 096 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 096</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 097 · heading</div>

### Record catalog

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 097</div>

### 记录目录

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 098 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 098</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 099 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 099</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 100 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 100</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 101 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 101</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 102 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 102</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 103 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 103</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 104 · heading</div>

### Validity

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 104</div>

### 有效性

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 105 · paragraph</div>

Recovery rejects a lane's log as corrupt when:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 105</div>

遇到以下情况，恢复流程必须认定 lane 日志已损坏：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 106 · list_item</div>

- more than one operation is open;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 106</div>

- 同时打开了多于一项操作；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 107 · list_item</div>

- a record references an operation that does not exist, or follows its finish;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 107</div>

- 记录引用不存在的操作，或出现在该操作结束之后；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 108 · list_item</div>

- attempt numbers are not consecutive within a step;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 108</div>

- 同一 step 内 attempt 编号不连续；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 109 · list_item</div>

- `compactionReason` is absent from a compaction attempt or present on another step kind;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 109</div>

- 压缩 attempt 缺少 `compactionReason`，或其他 step 类型错误地携带它；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 110 · list_item</div>

- a steer or follow-up `queue_enqueued` for a run follows its `abort_requested`;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 110</div>

- 某个 run 的 steer/follow-up `queue_enqueued` 出现在其 `abort_requested` 之后；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 111 · list_item</div>

- a `queue_cancelled` targets an id with no `queue_enqueued`, or one whose entry exists;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 111</div>

- `queue_cancelled` 指向没有对应 `queue_enqueued` 的 ID，或指向条目已存在的项目；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 112 · list_item</div>

- attempts in one structural step disagree on `resultEntryId`, or any attempts of one step disagree on `compactionReason`;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 112</div>

- 同一结构性 step 的 attempt 对 `resultEntryId` 或 `compactionReason` 意见不一致；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 113 · list_item</div>

- `tool_started.toolIndex` does not identify the stored `toolCallId` and `toolName` in its original assistant entry;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 113</div>

- `tool_started.toolIndex` 无法在原始 assistant 条目中定位保存的 `toolCallId` 和 `toolName`；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 114 · list_item</div>

- two `tool_started` records share an invocation identity;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 114</div>

- 两条 `tool_started` 记录使用同一调用身份；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 115 · list_item</div>

- a provisioned id exists with different content.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 115</div>

- 预分配 ID 已存在，但内容不同。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 116 · heading</div>

## 6. What each action writes

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 116</div>

## 6. 每种动作会写入什么

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 117 · paragraph</div>

Traces at the storage level. All traces show one lane. Legend:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 117</div>

以下是存储层级的执行轨迹，均只展示一个 lane。图例：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 118 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 118</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 119 · heading</div>

### Run with one tool call

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 119</div>

### 包含一次工具调用的 run

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 120 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 120</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 121 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 121</div>

任意两行之间发生崩溃都能恢复。一般规则是：没有结果条目的意图，由恢复流程补完、重试或用合成结果关闭；不存在“有结果条目、却没有相应已消费意图”的状态。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 122 · heading</div>

### Retry

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 122</div>

### 重试

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 123 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 123</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 124 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 124</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 125 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 125</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 126 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 126</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 127 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 127</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 128 · heading</div>

### Context overflow at an assistant step

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 128</div>

### Assistant step 的上下文溢出

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 129 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 129</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 130 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 130</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 131 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 131</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 132 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 132</div>

可恢复响应会被**丢弃**：它和可重试错误一样，永远不会成为条目，因此无论实时重试还是崩溃后重试，都不需要从上下文中清除它。该响应对应的预分配结果 ID 保持未履行；请求 settle 时写入的 `usage` 记录已经把它的成本持久化（第 5 节）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 133 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 133</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 134 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 134</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 135 · paragraph</div>

Per crash site:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 135</div>

各崩溃点的处理如下：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 136 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 136</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 137 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 137</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 138 · heading</div>

### Steering while a tool runs

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 138</div>

### 工具运行期间收到 steering

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 139 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 139</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 140 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 140</div>

如果在 `queue_enqueued` 之前崩溃，这次 steer 就从未发生，调用者的 Promise 也不会 resolve；如果在其后崩溃，恢复流程会找到一条尚无对应条目的队列记录，并在检查点原本应当消费它的位置完成追加。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 141 · paragraph</div>

A queued item can be durably retracted before consumption:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 141</div>

队列项目可以在消费前被持久撤回：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 142 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 142</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 143 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 143</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 144 · heading</div>

### Input at the finish boundary

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 144</div>

### 结束边界上的输入

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 145 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 145</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 146 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 146</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 147 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 147</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 148 · heading</div>

### Deferred write mid-turn

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 148</div>

### Turn 中途的延迟写入

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 149 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 149</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 150 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 150</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 151 · heading</div>

### Abort during a tool

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 151</div>

### 工具执行期间 abort

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 152 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 152</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 153 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 153</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 154 · heading</div>

### Tool execution crash sites

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 154</div>

### 工具执行的崩溃点

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 155 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 155</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 156 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 156</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 157 · paragraph</div>

Reconciliation handles each call of a batch at its own site, in source order. The step then ends normally.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 157</div>

收敛流程按原始顺序分别判断批次中的每个调用，之后 step 正常结束。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 158 · heading</div>

### Auto-compaction at a checkpoint

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 158</div>

### 检查点自动压缩

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 159 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 159</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 160 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 160</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 161 · heading</div>

### Navigation

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 161</div>

### 导航

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 162 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 162</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 163 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 163</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 164 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 164</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 165 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 165</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 166 · heading</div>

### Deferred provider request

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 166</div>

### 延迟 Provider 请求

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 167 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 167</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 168 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 168</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 169 · paragraph</div>

Each `resume()` performs one fetch. Three outcomes:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 169</div>

每次调用 `resume()` 只执行一次 fetch，结果分为三种：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 170 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 170</div>

- **pending**——Provider 再次返回停止原因 `deferred`。除可能写入一条 `usage` 记录外，不持久化任何内容（第 15 节）；lane 再次挂起。轮询频率由应用策略决定。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 171 · list_item</div>

- **ready** — a normal assistant message. It is appended as the successor and the run continues.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 171</div>

- **ready**——得到一条普通 assistant 消息。将其作为后继追加，然后正常继续 run。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 172 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 172</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 173 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 173</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 174 · paragraph</div>

Deferred assistant messages carry a handle, not content; they project to nothing in provider context.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 174</div>

deferred assistant 消息只携带 handle，不包含正文，因此投影到 Provider 上下文时不会产生任何内容。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 175 · heading</div>

## 7. Recovery

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 175</div>

## 7. 恢复

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 176 · heading</div>

### Restore

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 176</div>

### 还原

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 177 · paragraph</div>

Opening a session restores every lane independently. Restore reads; it never appends and never starts effects.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 177</div>

打开会话时，每个 lane 独立还原。还原过程只读取数据，不追加任何内容，也不启动任何副作用。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 178 · paragraph</div>

Recovery starts with indexed discovery, not a full log scan:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 178</div>

恢复从索引查询开始，而不是扫描完整日志：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 179 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 179</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 180 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 180</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 181 · list_item</div>

3. For a suspended lane, the open operation selects two bounded payload reads:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 181</div>

3. 对 suspended lane，打开的操作把读取范围限制为两段有界数据：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 182 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 182</div>

- **该 lane 的记录**：从这个 `operation_started` 开始读取。前一项操作结束之前的所有内容都属于无关历史。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 183 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 183</div>

- **该 lane 自己追加的条目**：从当前叶节点沿路径回溯到操作锚点 `sourceLeafId`。这些恰好就是本次操作追加的条目。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 184 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 184</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 185 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 185</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 186 · heading</div>

### The reduction

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 186</div>

### Reduction（状态归约）

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 187 · paragraph</div>

From those two reads, the lane's state:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 187</div>

根据上述两段读取，可以归约出 lane 状态：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 188 · list_item</div>

- **aborting** — an `abort_requested` record exists.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 188</div>

- **正在 abort**：存在 `abort_requested`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 189 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 189</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 190 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 190</div>

- **已经使用 overflow 恢复**——存在一条原因是 `overflow` 的 compaction `step_attempt`，而且它比当前 run 最新消费的对话消息更新（见第 6 节的 overflow guard）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 191 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 191</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 192 · list_item</div>

- **deferred handle** — the newest own entry is a deferred assistant message with no successor.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 192</div>

- **延迟 handle**：最新自有条目是没有后继的 deferred assistant 消息。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 193 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 193</div>

- **最新的本 lane 自有 entry**——也就是第二次读取返回的最后一条 entry；`needsAssistant()`、终止失败与 abort closure 等纯谓词都读取它。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 194 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 194</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 195 · list_item</div>

- **pending writes** — `write_deferred` records whose provisioned entry does not exist.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 195</div>

- **待处理写入**：预分配条目不存在的 `write_deferred`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 196 · list_item</div>

- **missing initial messages** — provisioned ids from the run intent without entries.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 196</div>

- **缺失初始消息**：run 意图中尚无条目的预分配 ID。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 197 · list_item</div>

- **structural targets** — for compaction and navigation: does the provisioned result entry exist.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 197</div>

- **结构性目标**：判断压缩或导航的预分配结果条目是否存在。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 198 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 198</div>

实时执行使用完全相同的规则：Harness 每次写入后更新内存状态，还原则从存储重新归约。状态由记录的 reduction 定义，因此两者不可能产生不同结论。`usage` 在这里不可见，因为它只负责记账，不参与编排。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 199 · heading</div>

### Resume

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 199</div>

### 恢复执行

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 200 · paragraph</div>

`resume()` continues the open operation from what the reduction says:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 200</div>

`resume()` 根据 reduction 继续已打开操作：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 201 · list_item</div>

- missing initial messages → append them (accepted input is never lost), even when aborting.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 201</div>

- 缺失初始消息：追加它们，即使已经进入 abort，也不能丢失已接受输入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 202 · list_item</div>

- aborting → reconcile: synthetic tool results, closing assistant message, `operation_finished` aborted.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 202</div>

- 正在 abort：补合成工具结果、结束 assistant 消息，并以 aborted 写 `operation_finished`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 203 · list_item</div>

- unresolved tool batch → per call: skip, re-execute, or synthesize (section 6).

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 203</div>

- 未解决工具批次：逐调用跳过、重执行或合成。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 204 · list_item</div>

- deferred handle → redeem (section 6).

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 204</div>

- 延迟 handle：兑现它。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 205 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 205</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 206 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 206</div>

- 未完成 step：先继续同一个 step，再消费新的检查点输入；未到上限则开始下一 attempt，否则让操作失败。压缩 step 使用已记录的 `compactionReason`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 207 · list_item</div>

- otherwise → continue at the next checkpoint; pending writes and queue items apply normally there.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 207</div>

- 其他情况 → 从下一个 checkpoint 继续；待处理写入和 queue item 会在那里按正常规则应用。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 208 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 208</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 209 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 209</div>

旧 v3 会话没有记录，因此所有 lane 查询都回答 idle。第 12 节的 normalization 会让 `main` 指向最终保留的逻辑条目；被丢弃的事实类条目通过最近保留祖先重新解析。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 210 · heading</div>

# Part III — API and implementation

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 210</div>

# 第三部分——API 与实现

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 211 · heading</div>

## 8. Public API

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 211</div>

## 8. 公共 API

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 212 · heading</div>

### The lane surface

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 212</div>

### Lane 接口

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 213 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 213</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 214 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 214</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 215 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 215</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 216 · heading</div>

### The harness

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 216</div>

### Harness

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 217 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 217</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 218 · heading</div>

### Options

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 218</div>

### 选项

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 219 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 219</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 220 · heading</div>

### Results and tagged errors

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 220</div>

### 结果与带标签错误

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 221 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 221</div>

公共 API 使用内置的一小部分 `better-result` v3 模式。`packages/agent` 不会因此增加对 `better-result` 的运行时依赖。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 222 · paragraph</div>

The subset contains only:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 222</div>

这个子集只包含：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 223 · list_item</div>

- serializable `Result.ok()` and `Result.err()` values;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 223</div>

- 可序列化的 `Result.ok()` 与 `Result.err()` 值；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 224 · list_item</div>

- `Result.isOk()` and `Result.isErr()` guards;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 224</div>

- `Result.isOk()` 与 `Result.isErr()` 类型守卫；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 225 · list_item</div>

- `TaggedError` with a literal `_tag`, readonly payload, normal `Error` behavior, `.toJSON()`, and class-level `.is()`;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 225</div>

- `TaggedError`：具有字面量 `_tag`、只读 payload、普通 `Error` 行为、`.toJSON()` 和类级别的 `.is()`；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 226 · list_item</div>

- exhaustive `matchError()`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 226</div>

- 穷尽式 `matchError()`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 227 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 227</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 228 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 228</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 229 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 229</div>

每种可预期的拒绝都对应一个类，其 tag 是字符串字面量，字段携带调用方需要的数据。应使用下面展示的 v3 class 写法；属性类型之后不要再加一个结尾的 `()`：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 230 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 230</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 231 · paragraph</div>

The remaining classes use the same base:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 231</div>

其余类使用相同的基类：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 232 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 232</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 233 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 233</div>

传输层把错误序列化为 `{ _tag, message, ...payload }`，并在代理边界重新构造对应的类。新增一种拒绝类会改变相应的错误 union；在调用方处理这个新 tag 之前，穷尽式 `matchError` 调用将无法通过类型检查。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 234 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 234</div>

`Err` 表示本次调用没有创建或接受所请求的工作。只要 Harness 仍处于打开且可写状态，每项已经接受的操作都会 resolve 为 `Ok`，其中也包括 outcome 为 `aborted`、`failed` 或 `suspended` 的操作：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 235 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 235</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 236 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 236</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 237 · paragraph</div>

A storage write failure is not an `Err`. It faults the harness and rejects the promise with `HarnessFault`:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 237</div>

存储写入失败不属于 `Err`。它会使 Harness 进入 faulted 状态，并以 `HarnessFault` reject Promise：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 238 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 238</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 239 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 239</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 240 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 240</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 241 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 241</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 242 · heading</div>

### Suspended operations

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 242</div>

### Suspended 操作

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 243 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 243</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 244 · heading</div>

### Examples

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 244</div>

### 示例

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 245 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 245</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 246 · heading</div>

## 9. Snapshots and subscription

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 246</div>

## 9. 快照与订阅

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 247 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 247</div>

UI 需要“当前状态 + 之后的每次变化”，两者之间不能有缺口。这也包括传输间隙：代理 Harness 的服务器必须先把快照交给客户端，任何事件才可上线路。`watch()` 在消费者启用交付前先缓冲事件。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 248 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 248</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 249 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 249</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 250 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 250</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 251 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 251</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 252 · paragraph</div>

Rules:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 252</div>

规则如下：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 253 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 253</div>

- 配置不放入快照。getter 返回当前值，`config_update` 事件通知 UI 重新读取，保持单一事实来源。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 254 · list_item</div>

- `streamingMessage` and `runningTools` let a client that attaches mid-turn render immediately, without replaying events.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 254</div>

- `streamingMessage` 和 `runningTools` 让中途连接的客户端无需重放事件即可立即渲染。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 255 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 255</div>

- 重连就是新建 `watch()`。对仍存活的 Harness，新快照含实时进度；只有进程死亡会丢失流状态。还原后的 Harness 不报告部分流，快照改为显示 suspended 操作；持久 transcript 仍完整。跨传输断线续接由服务层负责。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 256 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 256</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 257 · list_item</div>

- Watchers are independent; each has its own buffer and its own `start()` gate.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 257</div>

- watcher 相互独立，各自拥有缓冲区与 `start()` 闸门。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 258 · heading</div>

## 10. Events

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 258</div>

## 10. 事件

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 259 · paragraph</div>

One flat stream. `events.on(type, listener)` receives everything; lane watchers receive their lane's events (section 9).

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 259</div>

事件形成一条扁平流。`events.on(type, listener)` 接收全部匹配事件，lane watcher 只接收自己的事件。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 260 · paragraph</div>

Guarantees:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 260</div>

保证如下：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 261 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 261</div>

- **被动。** listener 抛错会被捕获，报告为 `handler_error` 事件并写 telemetry，绝不影响执行。处理 `handler_error` 的 listener 若再抛错，只送 telemetry，防止递归。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 262 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 262</div>

- **有序。** 交付遵循进程顺序，watcher 与 `events.on` 一致。并发 lane 的被动交付不承诺按 `seq` 排序；持久消费者使用 `getLog()`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 263 · list_item</div>

- Not persisted, not replayed. Reconnect means a new `watch()`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 263</div>

- **不持久化、不重放。** 重连获取新 `watch()`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 264 · list_item</div>

- Events that report durable facts fire after the fact is committed; what an event announces is already queryable.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 264</div>

- 报告持久化事实的 event 只有在该事实提交后才会发送；event 所公布的内容在发送时已经可以查询。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 265 · list_item</div>

- Events report final values, after hook transformation.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 265</div>

- 事件只报告钩子转换后的最终值。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 266 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 266</div>

- payload 可 JSON 序列化且不含秘密，服务器可原样代理。模型、工具等活对象只按名称引用，绝不嵌入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 267 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 267</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 268 · heading</div>

### Catalog

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 268</div>

### 事件目录

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 269 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 269</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 270 · heading</div>

### Nesting

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 270</div>

### 嵌套关系

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 271 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 271</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 272 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 272</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 273 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 273</div>

失败 attempt 依次发 `retry_scheduled`、`retry_start`，重试无论结果如何 settle 时再发 `retry_end`。`run_suspend` 结束该挂起 lane 当前事件流，下一次 `run_resume` 继续。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 274 · heading</div>

## 11. Hooks

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 274</div>

## 11. 钩子

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 275 · paragraph</div>

Hooks are awaited interception points. Registration mirrors events, with an optional stable registration id:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 275</div>

钩子是会被 await 的拦截点。注册方式与事件类似，并可带稳定注册 ID。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 276 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 276</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 277 · paragraph</div>

Semantics, uniform across all hooks:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 277</div>

全部钩子遵循以下统一语义：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 278 · list_item</div>

- Registration is harness-global. Every hook event carries `lane` (omitted below); a handler scopes itself.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 278</div>

- 注册范围是整个 Harness。每一个 hook event 都携带 `lane`（下文省略）；handler 据此限制自己的作用范围。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 279 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 279</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 280 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 280</div>

- `before_run` 在接受操作之前、mutation line 之外，对标准化调用 prompt 运行。它看不到随后由接受变更捕获的 next-run 项目。若 lane 已忙导致接受失败，其输出丢弃。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 281 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 281</div>

- handler 按注册顺序串行运行。每个转换 handler 看到前一个的输出；返回的 `messages` 追加，返回的 `systemPrompt` 替换当前值。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 282 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 282</div>

- handler 抛错不会让 run 失败：跳过它，报告 `handler_error`，继续后续 handler。唯一例外是 `before_tool` 必须 fail closed；抛错就阻止工具，避免被跳过的策略钩子放行原本可能拒绝的调用。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 283 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 283</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 284 · list_item</div>

- Events report post-hook values; observers never see pre-hook state.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 284</div>

- 事件报告钩子之后的值，观察者看不到转换前状态。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 285 · heading</div>

### Catalog

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 285</div>

### 钩子目录

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 286 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 286</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 287 · heading</div>

### Replay across retry and resume

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 287</div>

### 重试与恢复时的重放

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 288 · paragraph</div>

Hooks re-run only where the work itself re-runs. Persisted outputs are never recomputed.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 288</div>

钩子只在其对应工作本身重跑时重跑，已经持久化的输出绝不重新计算：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 289 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 289</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 290 · heading</div>

## 12. Session and SessionTree

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 290</div>

## 12. Session 与 SessionTree

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 291 · heading</div>

### Entries

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 291</div>

### 条目

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 292 · paragraph</div>

The tree content. No other entry types exist; pointers and global facts are not entries (section 2).

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 292</div>

条目构成对话树内容，除此之外不存在其他条目类型；指针和全局事实不是条目。类型包括 message、模型/思考/工具配置、compaction、branch summary 与 custom entry。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 293 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 293</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 294 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 294</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 295 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 295</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 296 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 296</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 297 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 297</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 298 · list_item</div>

- `custom_message` becomes a custom agent message.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 298</div>

- `custom_message` 变为 custom agent message；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 299 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 299</div>

- `label` 与 `session_info` 会转换为全局 fact（按文件位置取最后一个值），并从逻辑树中消失。Label 的 target 是其最近的、被保留的 parent。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 300 · list_item</div>

- Each retained child of a discarded entry is reparented to the discarded entry's nearest retained ancestor.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 300</div>

- 被丢弃 entry 的每一个保留 child，都要重新挂到该被丢弃 entry 最近的保留祖先上。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 301 · list_item</div>

- `main`'s leaf is the final physical entry resolved through discarded entries to its nearest retained ancestor.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 301</div>

- `main` 的 leaf 是最后一个物理 entry；若它位于被丢弃 entry 上，则沿这些被丢弃 entry 向上解析到最近的保留祖先。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 302 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 302</div>

- 旧 compaction 会在自身 branch 上解析 `firstKeptEntryId`，并把对应范围实体化为 `retainedTail`。V4 绝不会公开或持久化 `firstKeptEntryId`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 303 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 303</div>

- Compaction entry 与 branch-summary entry 上已有的 `details` 和 `usage` 保持不变。已有的 `fromHook` 来源也保持不变；若 v3 中没有该值，则规范化为 `false`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 304 · list_item</div>

- v3 entry timestamps are ISO strings and convert to Unix milliseconds.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 304</div>

- v3 ISO 时间戳转换为 Unix 毫秒。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 305 · paragraph</div>

Read-only opens keep the physical v3 file unchanged; the first v4 write persists the normalized form (section 13).

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 305</div>

只读 open 会保持物理 v3 文件不变；第一次 v4 写入才会把规范化后的形式持久化（见第 13 节）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 306 · heading</div>

### SessionTree

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 306</div>

### SessionTree

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 307 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 307</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 308 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 308</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 309 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 309</div>

查询语义：分支扫描先取得从 `start` 到根节点的路径，按 `order` 方向遍历，在首次命中 `stopAt` 后停止并包含匹配项，随后过滤结果，最后应用 `limit` 与 `cursor`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 310 · list_item</div>

- `newestFirst` with `stopAtType: "compaction"` ends at the newest compaction: the context window.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 310</div>

- `newestFirst` 配合 `stopAtType: "compaction"` 会在最新一次 compaction 处结束：这就是当前上下文窗口。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 311 · list_item</div>

- `type` and `customType` filter results; a `stopAt` entry is returned only if it passes the filter.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 311</div>

- `type` 与 `customType` 用于过滤结果；`stopAt` entry 只有在通过过滤时才会返回。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 312 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 312</div>

- 扩展模式：有效状态 = `findEntryOnBranch({ type: "custom", customType })`；集合 = `findEntriesOnBranch(...)`；全局盘点 = `findEntries(...)`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 313 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 313</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 314 · list_item</div>

- `SessionTree` has no navigation; moving a lane is `navigateTree()` on the lane.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 314</div>

- `SessionTree` 不提供导航能力；移动 lane 必须调用该 lane 上的 `navigateTree()`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 315 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 315</div>

finder 和 `getEntry` 只返回已经提交的条目。延迟写入在真正应用前不属于树，因此 handler 请求追加后，立即查询也看不到自己的写入；快照会使用预分配 ID 展示这些待处理写入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 316 · heading</div>

### Session

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 316</div>

### Session

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 317 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 317</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 318 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 318</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 319 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 319</div>

`Session` 不暴露 `getStorage()` 之类的逃生口；所有写入都必须流经 `Session`，它就是存储契约所假定的单一写者。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 320 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 320</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 321 · heading</div>

## 13. Storage

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 321</div>

## 13. 存储

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 322 · heading</div>

### Contract

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 322</div>

### 契约

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 323 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 323</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 324 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 324</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 325 · paragraph</div>

Contract rules, all backends:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 325</div>

全部后端遵守：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 326 · list_item</div>

- One monotonic `seq` across entries, records, facts, and lane moves.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 326</div>

- 条目、记录、事实和 lane move 共用一个单调 `seq`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 327 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 327</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 328 · list_item</div>

- A write is durable when its promise resolves; events fire after.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 328</div>

- promise resolve 时写入即持久化，之后才发事件。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 329 · list_item</div>

- `Session` and the harness provision ids with `session.idGenerator`; storage enforces per-session uniqueness at append.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 329</div>

- `Session` 与 Harness 使用 `session.idGenerator` 预分配 ID；storage 在 append 时强制保证 ID 在 session 内唯一。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 330 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 330</div>

- 每个持久化 payload 都必须能够序列化为 JSON。`Session` 会在 dispatch 前验证，使 Memory、JSONL 与 SQLite 接受完全相同的值；Memory 不能保留任何会被 JSONL 拒绝的值。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 331 · list_item</div>

- Reads return immutable data.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 331</div>

- 读取返回不可变数据。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 332 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 332</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 333 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 333</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 334 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 334</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 335 · list_item</div>

- Any write failure faults the harness (section 4). The store is left a valid prefix.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 335</div>

- 任何写失败使 Harness faulted，存储仍保留有效前缀。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 336 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 336</div>

- 全局 fact 与 lane move 的历史都会保留，绝不重写；按 `seq` 取最新值。保存历史也是成本更低的实现方式——只 insert，不 update——而且如果未来有人需要，lane-move 历史天然就是一份 reflog。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 337 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 337</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 338 · heading</div>

### Memory

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 338</div>

### Memory

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 339 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 339</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 340 · heading</div>

### JSONL

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 340</div>

### JSONL

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 341 · paragraph</div>

The concrete repository is `JsonlSessionRepo`. Its metadata and options extend the backend-neutral contracts:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 341</div>

具体仓库实现是 `JsonlSessionRepo`。它的元数据和选项扩展了与后端无关的契约：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 342 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 342</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 343 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 343</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 344 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 344</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 345 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 345</div>

每个会话对应一个文件：第一行是 header，之后每行一个 JSON 对象，并按 `seq` 排列。每项逻辑变更恰好占一行；一行就是原子单位。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 346 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 346</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 347 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 347</div>

- 打开文件时会把整个文件读入内存，之后所有查询都针对这份内存状态执行。一个会话级追加队列串行化所有 lane 的写入，每次写一行；队列负责分配 `seq`，队列顺序就是文件行顺序。本节中的每项存储变更都只需要一行，整个设计不依赖多行原子写。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 348 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 348</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 349 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 349</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 350 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 350</div>

- 尾部撕裂：如果最后一行格式错误，说明追加操作在写到一半时进程退出。打开时将它截掉；该写入从未得到确认，因此不算丢失数据。其他位置出现格式错误则属于数据损坏，打开操作必须拒绝。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 351 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 351</div>

- 持久性保证只覆盖进程崩溃：追加调用 resolve 后，数据能够跨进程崩溃保存。这里不承诺 `fsync`；如果将来需要抵抗断电，必须把它设计成显式能力。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 352 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 352</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 353 · heading</div>

### SQLite

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 353</div>

### SQLite

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 354 · paragraph</div>

SQLite uses a greenfield schema with one persisted leaf per lane.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 354</div>

SQLite 使用一套全新 schema，每个 lane 持久保存一个叶节点。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 355 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 355</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 356 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 356</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 357 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 357</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 358 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 358</div>

`branch_entries` 和 `branch_tips` 是私有读取缓存。接口不会暴露它们，其他后端也不需要实现它们；从 parent pointer 重建这些表是一项显式修复操作，绝不是运行时兜底路径。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 359 · paragraph</div>

Two invariants carry the whole design:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 359</div>

整个设计依赖两条不变量：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 360 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 360</div>

- **每个条目至少属于一个分支。** 每次追加都把新条目插入一个分支——要么扩展现有分支，要么复制出新分支，具体见下文。一个分支保存从根开始的完整路径；只要两个分支都包含某个条目，它们在该条目以下的路径就必然一致，因为父链是唯一的。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 361 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 361</div>

- **分支 tip 唯一。** 一个分支的末尾始终是刚刚创建的新条目：无论扩展还是复制，都会把全新条目放在末尾。因此两个分支不会共享同一个 tip。`branch_tips` 通过一次点查询就能回答“是否有分支结束于 X”，结果只能是 0 行或 1 行。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 362 · paragraph</div>

**Read plan** — `findEntriesOnBranch({ start })`, any entry, tip or not:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 362</div>

**读取计划**——`findEntriesOnBranch({ start })` 的 `start` 可以是任意条目，不要求它是 tip：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 363 · list_item</div>

1. Reverse index: look up `start` → any containing branch.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 363</div>

1. 反向索引：查询 `start` 所在的任意一个分支。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 364 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 364</div>

2. 对该分支做范围扫描，条件为 `entry_seq <= start.seq`（父节点先于子节点，因此路径顺序等于 `seq` 顺序），连接 entries，再应用过滤和停止条件。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 365 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 365</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 366 · list_item</div>

1. `leaf = lanes[lane].leaf_id`; allocate `seq` from `session_sequences`; insert the entry with `parent_id = leaf`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 366</div>

1. 读取 `leaf = lanes[lane].leaf_id`；从 `session_sequences` 分配 `seq`；以 `parent_id = leaf` 插入条目。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 367 · list_item</div>

2. `branch_tips` lookup: does a branch end at `leaf`?

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 367</div>

2. 查询 `branch_tips`：是否有分支结束于 `leaf`？

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 368 · list_item</div>

- Yes → insert one `branch_entries` row there; update that tip to the new entry.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 368</div>

- 有：向该分支插入一行 `branch_entries`，并把 tip 更新为新条目。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 369 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 369</div>

- 没有：创建新分支。从任意包含 `leaf` 的分支复制 `entry_seq <= leaf.seq` 的行，再插入新条目对应的行和它的 tip。（lane 为空时无需复制，直接创建只有新条目的分支。）

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 370 · list_item</div>

3. `lanes[lane].leaf_id = entry.id`. Update fact/stats projections. Commit, then events.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 370</div>

3. 设置 `lanes[lane].leaf_id = entry.id`，更新 fact/stats projection，提交事务，然后发送事件。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 371 · paragraph</div>

The four cases, `Bn: [...]` are one branch's rows in seq order:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 371</div>

下面列出四种情况；`Bn: [...]` 表示一个分支中按 `seq` 排列的行：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 372 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 372</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 373 · paragraph</div>

Stale branches (no lane resolves through them) are kept.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 373</div>

没有 lane 能通过其路径到达的旧分支仍会保留。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 374 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 374</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 375 · paragraph</div>

SQLite implementation follow-ups:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 375</div>

SQLite 实现还需要完成以下后续工作：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 376 · list_item</div>

- Finish search backend work now in progress.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 376</div>

- 完成当前正在进行的搜索后端工作。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 377 · list_item</div>

- Add limit and cursor support to search results.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 377</div>

- 为搜索结果增加 limit 和 cursor 支持。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 378 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 378</div>

- 在可行时，让 `findEntries` 使用索引或搜索后端查询路径，而不是解码并过滤会话的全部条目。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 379 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 379</div>

- 完成搜索和 `findEntries` 修改后，重新审计 SQLite 查询计划，判断是否还需要增加索引或调整查询形状。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 380 · heading</div>

## 14. Agent-loop building blocks

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 380</div>

## 14. Agent loop 构建块

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 381 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 381</div>

`agent-loop.ts` 暴露不拥有持久状态、也不知道 session、record 或 lane 的基础构建块。Harness 负责组合它们，并在各阶段之间插入持久化写入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 382 · heading</div>

### Streaming one assistant response

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 382</div>

### 流式生成一次 assistant 响应

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 383 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 383</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 384 · heading</div>

### Tool execution

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 384</div>

### 工具执行

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 385 · paragraph</div>

Tools declare recovery safety. Omission means `"never"`:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 385</div>

工具需要声明自身是否能安全恢复。省略时默认为 `"never"`：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 386 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 386</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 387 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 387</div>

每个调用分为三个阶段。之所以分别公开，是因为 Harness 需要在阶段之间写入，而恢复流程需要跳过阶段 1、直接执行阶段 2 和阶段 3：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 388 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 388</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 389 · heading</div>

### Compatibility wrapper

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 389</div>

### 兼容包装器

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 390 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 390</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 391 · heading</div>

## 15. Harness internals

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 391</div>

## 15. Harness 内部实现

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 392 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 392</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 393 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 393</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 394 · heading</div>

### The effects boundary

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 394</div>

### Effects 边界

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 395 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 395</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 396 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 396</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 397 · paragraph</div>

Rules:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 397</div>

规则如下：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 398 · list_item</div>

- Reads (`getEntry`, `findEntriesOnBranch`, context building, id allocation) are not effects and never gate.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 398</div>

- 读取操作（`getEntry`、`findEntriesOnBranch`、上下文构建、ID 分配）不是副作用，永远不会被 gate 拦住。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 399 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 399</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 400 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 400</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 401 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 401</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 402 · heading</div>

### The lane mutation line

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 402</div>

### Lane mutation line

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 403 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 403</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 404 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 404</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 405 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 405</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 406 · paragraph</div>

The jobs, by caller:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 406</div>

下面按调用方列出这些 job：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 407 · list_item</div>

- **Lane surface** (ungated, enqueue directly):

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 407</div>

- **Lane 接口**（不经过 gate，直接入队）：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 408 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 408</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 409 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 409</div>

- *接受队列项目*（`steer`、`followUp`）——校验存在活动且未 abort 的 run，然后写入 `queue_enqueued`。`nextRun` 无需校验，始终接受。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 410 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 410</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 411 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 411</div>

- *接受延迟写入*（lane view 写入、配置 setter）——run 打开时写入 `write_deferred`；结构性操作打开时等待其结束，然后重新进入；idle 时直接追加条目。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 412 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 412</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 413 · list_item</div>

- *Resume admission* — reserve the lane's single execution slot; no write.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 413</div>

- *允许 resume*——占用该 lane 唯一的执行槽，不产生写入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 414 · list_item</div>

- **Procedure via `fx`** (gated in manual mode):

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 414</div>

- **procedure 通过 `fx` 执行的 job**（manual 模式下经过 gate）：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 415 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 419</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 420 · list_item</div>

- Plain `appendEntry`/`appendRecord`/`moveLane`/`setFact` — unconditional single writes, still serialized by the line.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 420</div>

- 普通 `appendEntry` / `appendRecord` / `moveLane` / `setFact`——都是无条件的单次写入，但仍通过 mutation line 串行化。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 421 · paragraph</div>

Two examples, both orders legal, nothing else possible:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 421</div>

下面是两个例子；每个例子都只允许两种顺序，不可能出现其他历史：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 422 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 422</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 423 · heading</div>

### Race catalog

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 423</div>

### 竞态目录

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 424 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 424</div>

下表是完整清单。每一行都给出两种合法历史，以及强制形成这两种历史的 job。Tier C（第 19 节）会测试每一行的两种顺序。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 425 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 425</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 426 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 426</div>

第 10 行是唯一无法通过排序消除的竞态：外部副作用可能已经发生，但结果尚未送达。该设计的回答是第 5 节的意图记录加重放策略——与处理进程崩溃使用的是同一个答案。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 427 · heading</div>

### Drive modes

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 427</div>

### Drive 模式

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 428 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 428</div>

`drive: "automatic"` 直接透传 `fx`，没有额外开销。`drive: "manual"` 则用 gate 包装当前操作的 `fx`：每次方法调用都会在真正执行前停驻，并暴露一份可 JSON 序列化的描述。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 429 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 429</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 430 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 430</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 431 · paragraph</div>

The public controls, on the lane (section 8):

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 431</div>

lane 上的公共控制方法（第 8 节）如下：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 432 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 432</div>

- `peekAction()` 返回下一次停驻调用的描述；如果没有操作或操作已经 settle，则返回 `undefined`。它不产生副作用，连续调用两次会返回同一个 action。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 433 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 433</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 434 · list_item</div>

- `runToCompletion()` releases until the operation settles.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 434</div>

- `runToCompletion()` 持续释放 action，直到操作 settle。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 435 · list_item</div>

- Two concurrent drivers are a programmer defect, as is calling the controls in automatic mode.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 435</div>

- 同时存在两个 driver 属于程序缺陷；在 automatic 模式下调用这些控制方法同样属于程序缺陷。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 436 · paragraph</div>

Semantics that make tests deterministic:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 436</div>

为了让测试具有确定性，gate 还遵循以下语义：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 437 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 437</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 438 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 438</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 439 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 439</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 440 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 440</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 441 · heading</div>

### Live lane state

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 441</div>

### 实时 lane 状态

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 442 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 442</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 443 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 443</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 444 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 444</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 445 · heading</div>

### Dispatch

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 445</div>

### Dispatch

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 446 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 446</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 447 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 447</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 448 · heading</div>

### The loop

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 448</div>

### 主循环

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 449 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 449</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 450 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 450</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 451 · heading</div>

### Steps

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 451</div>

### Step

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 452 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 452</div>

一次失败的尝试不会向树中追加任何内容。除成功响应外，只有 deferred handle、终止消息或最终放弃时的错误会进入树中（见第 6 节的重试 trace）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 453 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 453</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 454 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 454</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 455 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 455</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 456 · heading</div>

### Deferred redemption

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 456</div>

### 兑现延迟结果

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 457 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 457</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 458 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 458</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 459 · heading</div>

### Tools

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 459</div>

### 工具

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 460 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 460</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 461 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 461</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 462 · paragraph</div>

The recovery path handles each call at its crash site, in source order, keeping original ordinals:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 462</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 463 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 463</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 464 · heading</div>

### Abort

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 464</div>

### Abort

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 465 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 465</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 466 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 466</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 467 · heading</div>

### Structural operations

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 467</div>

### 结构性操作

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 468 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 468</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 469 · paragraph</div>

Hook-to-block wiring, in one table:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 469</div>

Harness hook 与代码块插入点的对应关系如下：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 470 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 470</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 471 · paragraph</div>

Notes:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 471</div>

注意：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 472 · list_item</div>

- Auto-compaction inside a run runs under the run's own records; no nested operation.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 472</div>

- run 内部的自动压缩使用该 run 自己的 record，不创建嵌套 operation。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 473 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 473</div>

- 代码中没有单独的“step 执行到一半时崩溃”状态：一次被中断的尝试，就是一条尚无结果 entry 的 attempt；系统通过次数上限判断应继续重试，还是抛出 `RunFailed`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 474 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 474</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 475 · list_item</div>

- An aborted assistant message (`stopReason: "aborted"`) skips tool execution; `abortPath()` owns the synthetic results.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 475</div>

- `stopReason: "aborted"` 的 assistant 消息会跳过工具执行；合成结果由 `abortPath()` 负责写入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 476 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 476</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 477 · heading</div>

## 16. pi-ai: deferred requests

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 477</div>

## 16. pi-ai：deferred 请求

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 478 · paragraph</div>

Everything is per-request; batch APIs can implement the same shape through a custom provider.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 478</div>

所有能力都按单次请求定义；批处理 API 可以通过自定义 Provider 实现同样的形态。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 479 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 479</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 480 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 480</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 481 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 481</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 482 · paragraph</div>

The harness uses the authenticated `Models` dispatch surface rather than talking to a provider object directly:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 482</div>

Harness 使用经过认证的 `Models` dispatch 接口，而不是直接与 Provider 对象通信：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 483 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 483</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 484 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 484</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 485 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 485</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 486 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 486</div>

Deferred assistant 消息只携带 handle，不携带正文。Session 的上下文投影会从 Provider 上下文中省略这类消息；持久化的 suspended 状态与后续兑现都使用已经保存的 handle。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 487 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 487</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 488 · heading</div>

## 17. Forks and subagents

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 488</div>

## 17. Fork 与 subagent

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 489 · paragraph</div>

One copy primitive on the session repository:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 489</div>

Repository 只提供一个 copy primitive：branch scope 复制从根到指定 fork point 的一条路径，tree scope 复制全部条目与分支。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 490 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 490</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 491 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 491</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 492 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 492</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 493 · list_item</div>

- Facts: `scope: "tree"` copies all; `scope: "branch"` copies the name always, labels only when their target entry was copied.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 493</div>

- Fact：`scope: "tree"` 会复制全部 fact；`scope: "branch"` 始终复制 name，而 label 只有在其 target entry 也被复制时才复制。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 494 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 494</div>

- fork point 可为任意消息条目。即使停在工具批次中途仍可 prompt，因为 pi-ai 构建请求时会为孤立工具调用插入合成空结果。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 495 · list_item</div>

- The source is untouched; copying while it runs reads the committed prefix.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 495</div>

- 源会话不变；运行期间复制只读取已提交前缀。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 496 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 496</div>

- 父子链接使用 `parentSessionId`：它由 `fork()` 设置，也可以在 `create()` 时设置，是 subagent 父子跟踪与导出 bundle 的基础。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 497 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 497</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 498 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 498</div>

- 共享频道历史的平台 thread 应建 lane；fork 用于隔离，例如 subagent、导出和 clone。不需要隔离时，subagent 也可使用父会话中的另一 lane。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 499 · heading</div>

## 18. Telemetry

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 499</div>

## 18. Telemetry

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 500 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 500</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 501 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 501</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 502 · heading</div>

### Package ownership

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 502</div>

### 包归属

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 503 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 503</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 504 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 504</div>

`AgentHarnessOptions.telemetryContext` 默认使用 no-op context；Agent 侧的请求包装器通过 Agent 自己拥有的 AI schema 发送 `pi.ai.request`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 505 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 505</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 506 · heading</div>

### Context contract

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 506</div>

### Context 契约

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 507 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 507</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 508 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 508</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 509 · list_item</div>

- return or resolve: default status `ok`, then automatic end;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 509</div>

- 正常 return 或 resolve：使用默认状态 `ok`，然后自动结束；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 510 · list_item</div>

- synchronous throw: return a promise rejected with the same thrown value, after automatic error status and end;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 510</div>

- 同步 throw：自动设置错误状态并结束 span，随后返回一个以原始抛出值 reject 的 promise；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 511 · list_item</div>

- asynchronous rejection: automatic error status and end, then rejection with the same value;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 511</div>

- 异步 reject：自动设置错误状态并结束 span，随后以同一个值 reject；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 512 · list_item</div>

- expected failure represented by a value: the callback calls `setStatus({ status: "error", ... })` before returning;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 512</div>

- 以返回值表示的预期失败：callback 在返回前调用 `setStatus({ status: "error", ... })`；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 513 · list_item</div>

- repeated `setStatus()` calls are last-write-wins; automatic completion never overwrites an explicit status;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 513</div>

- 多次调用 `setStatus()` 时，以最后一次写入为准；自动完成绝不会覆盖显式设置的状态；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 514 · list_item</div>

- `setAttributes()` merges keys; a later defined value overwrites an earlier one and `undefined` is ignored;

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 514</div>

- `setAttributes()` 会合并各个 key；后写入的已定义值会覆盖先前值，`undefined` 会被忽略；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 515 · list_item</div>

- calls on a settled span are inert and never throw.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 515</div>

- Span settle 之后，对它的调用不再产生任何作用，也绝不会抛错。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 516 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 516</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 517 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 517</div>

Harness runtime 把 context 作为普通参数传给每一个会产生 effect 的实现边界。核心函数都不会查找所谓的当前 context：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 518 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 518</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 519 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 519</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 520 · heading</div>

### Typed schema

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 520</div>

### 类型化 schema

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 521 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 521</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 522 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 522</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 523 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 523</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 524 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 524</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 525 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 525</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 526 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 526</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 527 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 527</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 528 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 528</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 529 · heading</div>

#### AI request schema

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 529</div>

#### AI 请求 schema

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 530 · paragraph</div>

`AI_TELEMETRY_SCHEMA` declares no pi-written span events and one span. Its parent rule is `{ kind: "any" }`:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 530</div>

`AI_TELEMETRY_SCHEMA` 声明了一个 span，且不声明任何由 pi 写入的 span event。它的 parent 规则为 `{ kind: "any" }`：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 531 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 531</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 532 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 532</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 533 · heading</div>

#### Harness schema

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 533</div>

#### Harness schema

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 534 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 534</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 535 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 535</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 536 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 536</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 537 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 537</div>

动态 ID 和名称始终是 attribute，绝不能成为 span 名称。Schema 定义穷尽了 pi instrumentation 可以发送的全部词汇。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 538 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 538</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 539 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 539</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 540 · heading</div>

### Effects and nesting

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 540</div>

### Effect 与嵌套

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 541 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 541</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 542 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 542</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 543 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 543</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 544 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 544</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 545 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 545</div>

Context 对象和 adapter 原生 span 都是进程本地能力。二者都不会持久化到 record、entry、snapshot、event 或 deferred handle 中。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 546 · heading</div>

### Span lifetime

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 546</div>

### Span 生命周期

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 547 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 547</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 548 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 548</div>

- 返回 `completed`、`declined`、`aborted` 或 `suspended` 结果时会正常 resolve；instrumentation 可以用匹配的合法 outcome 补充 span；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 549 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 549</div>

- 返回 `failed` 结果时会显式设置错误状态，但仍按公共 API 的要求正常 resolve；同时也可以补充 outcome `failed`；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 550 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 550</div>

- `close()`、Harness fault 或不变量缺陷会使 callback reject，因此本地 span 会自动以错误状态结束；

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 551 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 551</div>

- 真实进程退出不会执行清理，所以后端可能丢失未完成 span，也可能保留它；下一个进程只需在 `resume()` 时创建新 span。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 552 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 552</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 553 · paragraph</div>

The span tree follows execution scopes:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 553</div>

Span tree 遵循执行 scope：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 554 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 554</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 555 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 555</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 556 · heading</div>

### Safety and testing

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 556</div>

### 安全与测试

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 557 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 557</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 558 · paragraph</div>

Telemetry remains separate from events and hooks:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 558</div>

Telemetry 与 event、hook 始终相互独立：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 559 · list_item</div>

- Events are public live observation.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 559</div>

- Event 用于公开的实时观察。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 560 · list_item</div>

- Hooks can change execution.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 560</div>

- Hook 可以改变执行过程。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 561 · list_item</div>

- Telemetry is passive process-local diagnostics.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 561</div>

- Telemetry 是被动的进程本地诊断信息。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 562 · heading</div>

## 19. Testing strategy

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 562</div>

## 19. 测试策略

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 563 · paragraph</div>

Three tiers. Each tests a different claim; none replaces another.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 563</div>

测试分三层，每层验证不同主张，互相不能替代。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 564 · heading</div>

### Tier A — reduction and resume

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 564</div>

### Tier A——Reduction 与 resume

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 565 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 565</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 566 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 566</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 567 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 567</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 568 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 568</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 569 · heading</div>

### Tier B — writer conformance

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 569</div>

### Tier B——Writer 一致性

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 570 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 570</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 571 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 571</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 572 · heading</div>

### Tier C — deterministic interleavings

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 572</div>

### Tier C——确定性交错

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 573 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 573</div>

针对真实 `AgentHarness`、faux Provider 和真实后端使用 `drive: "manual"`。Gate 是唯一的测试 hook，不存在第二套状态机。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 574 · fence</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 574</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 575 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 575</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 576 · paragraph</div>

Gate invariants, asserted across Tier C:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 576</div>

Tier C 会断言以下 gate 不变量：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 577 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 577</div>

- 每次 `resume()` 得出 outcome 后，重新计算的 reduction 中的 `laneState` 都等于 live `LaneState`（第 15 节的 fixed-point 自检已经触发并通过）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 578 · list_item</div>

- `peekAction()` has no side effect and is stable until `executeAction()`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 578</div>

- `peekAction()` 没有副作用，并且在调用 `executeAction()` 前保持稳定。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 579 · list_item</div>

- `executeAction()` releases exactly the peeked action, never a later one.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 579</div>

- `executeAction()` 只会释放刚刚 peek 到的那个 action，绝不会释放更后的 action。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 580 · list_item</div>

- Stopping before an action leaves exactly the preceding durable prefix.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 580</div>

- 在某个 action 之前停止，只会留下恰好截止到前一个 action 的持久化前缀。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 581 · list_item</div>

- While parked, zero storage writes and zero provider or tool calls happen (construction rule, section 15).

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 581</div>

- Parked 期间，存储写入、Provider 调用和工具调用都必须为零（第 15 节的构造规则）。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 582 · list_item</div>

- Every accepted operation gets exactly one `operation_finished` unless it suspends.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 582</div>

- 每个已接受的 operation 都恰好得到一条 `operation_finished`，除非它进入 suspended 状态。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 583 · list_item</div>

- A faulted append leaves a valid prefix and faults the whole harness.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 583</div>

- 追加操作发生 fault 时，会留下一个有效前缀，并使整个 Harness 进入 faulted 状态。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 584 · heading</div>

### Other suites

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 584</div>

### 其他测试套件

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 585 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 585</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 586 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 586</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 587 · list_item</div>

- The existing `agent-loop` and `agent` suites pass unchanged — the section 14 compatibility criterion.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 587</div>

- 现有 `agent-loop` 与 `agent` 测试套件无需修改即可通过——这是第 14 节的兼容性标准。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 588 · list_item</div>

- Event ordering per section 10, including `message_end` after commit.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 588</div>

- 第 10 节定义的 event 顺序，包括提交后的 `message_end`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 589 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 589</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 590 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 590</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 591 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 591</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 592 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 592</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 593 · heading</div>

## 20. Implementation status and work packages

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 593</div>

## 20. 实现状态与工作包

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 594 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 594</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 595 · heading</div>

### Claiming and completing a package

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 595</div>

### 认领与完成工作包

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 596 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 596</div>

1. 与 `main` 同步。只有同时满足以下条件的包才能认领：checkbox 为空；每个依赖项都已勾选；没有 active reservation 占有该包或与其重叠的 primary file。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 597 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 597</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 598 · list_item</div>

3. Start from the reservation commit. Read the referenced design and primary files.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 598</div>

3. 从 reservation commit 开始工作。阅读条目引用的设计文档和 primary file。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 599 · list_item</div>

4. Work in this loop:

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 599</div>

4. 按以下循环开展工作：

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 600 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 600</div>

1. 在工作包的 primary file 内实现条目描述的行为。尚未完成的公共 operation 必须继续以 `HarnessNotImplemented` reject。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 601 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 601</div>

2. 实现全面且聚焦的测试，把该包的验收标准以及它拥有的每一条设计不变量编码为测试。只有 smoke test 和 happy path 覆盖是不够的；每一条归该包所有的不变量都必须有可执行断言。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 602 · list_item</div>

3. Iterate on the implementation and tests until the behavior is complete and all affected tests pass.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 602</div>

3. 反复迭代实现与测试，直到行为完整，且所有受影响测试全部通过。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 603 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 603</div>

4. 如果设计无法成立，停止实现并在 Discord 上咨询 Mario。达成一致后，先更新设计和工作包描述，再回到第 1 步。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 604 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 604</div>

5. 运行 `npm run check`。实现 PR 或 commit 必须删除对应 reservation，并把包的 checkbox 改为已勾选。如果放弃该工作，则删除 reservation，但不要勾选工作包。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 605 · heading</div>

### Track F — scaffold truth and public ownership

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 605</div>

### Track F——脚手架真实性与公共所有权

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 606 · list_item</div>

- [x] **F0 — harden the scaffold.** Dependencies: none.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 606</div>

- [x] **F0——加固脚手架。** 依赖：无。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 607 · list_item</div>

- Primary files: `packages/agent/src/harness/agent-harness.ts`, `packages/agent/test/harness/agent-harness-scaffold.test.ts`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 607</div>

- Primary file：`packages/agent/src/harness/agent-harness.ts`、`packages/agent/test/harness/agent-harness-scaffold.test.ts`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 608 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 608</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 609 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 609</div>

- 在 R3 之前，`AgentHarness.create()` 只能打开不含 record 的 session。遇到任何含有 record 的 session 都必须 reject，不能谎报空的 suspended 列表。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 610 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 610</div>

- 验收：表驱动的 scaffold 测试覆盖每个公共方法，并证明所有未完成方法都不会返回貌似合理的成功结果。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 611 · heading</div>

### Public method ownership

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 611</div>

### 公共方法归属

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 612 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 612</div>

下表穷尽所有公共接口。在某个工作包拥有表中列出的语义与测试之前，不得从对应方法中移除 `HarnessNotImplemented`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 613 · table</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 613</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 614 · heading</div>

### Track QA — legacy test salvage

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 614</div>

### Track QA——旧测试挽救

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 615 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 615</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 616 · list_item</div>

- [x] **QA1 — inventory removed tests.** Dependencies: none.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 616</div>

- [x] **QA1——盘点已移除测试。** 依赖：无。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 617 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 617</div>

- 盘点 Harness promotion 时移除的测试，并记录每个用例是已覆盖、不适用，还是被新的实现工作包阻塞。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 618 · list_item</div>

- Acceptance: every removed case has a disposition in the matrix; no production or test code changes.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 618</div>

- 验收：matrix 中的每个已移除用例都有明确处置结论；不修改生产代码或测试代码。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 619 · list_item</div>

- [x] **QA2 — salvage storage and query tests.** Dependencies: QA1, R0.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 619</div>

- [x] **QA2——挽救存储与查询测试。** 依赖：QA1、R0。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 620 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 620</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 621 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 621</div>

- 验收：每个已审查的存储／查询用例，都由引用的现有测试覆盖、被移植为全面的不变量测试、标记为不适用，或明确保留为被 J1–J6 阻塞。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 622 · list_item</div>

- [ ] **QA3 — salvage remaining legacy tests.** Dependencies: QA2, J6, O2.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 622</div>

- [ ] **QA3——挽救其余旧测试。** 依赖：QA2、J6、O2。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 623 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 623</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 624 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 624</div>

- 验收：matrix 的每一行最终都由引用的现有测试覆盖、由新的全面测试移植，或显式标记为不适用；不能再有 blocked 或 uncovered 行。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 625 · heading</div>

### Track R — recovery query, reducer, and restore

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 625</div>

### Track R——恢复查询、Reducer 与 restore

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 626 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 626</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 627 · list_item</div>

- [x] **R0 — recovery-query contract.** Dependencies: none.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 627</div>

- [x] **R0——recovery-query 契约。** 依赖：无。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 628 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 628</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 629 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 629</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 630 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 630</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 631 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 631</div>

- 验收：Memory 与 SQLite 的查询行为完全相同；非法查询组合会 reject；任何 restore 算法都不需要扫描完整历史。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 632 · list_item</div>

- [x] **R1 — pure record-log validity.** Dependencies: R0.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 632</div>

- [x] **R1——纯 record-log 有效性。** 依赖：R0。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 633 · list_item</div>

- Primary files: `packages/agent/src/harness/reducer.ts`, `packages/agent/test/harness/reducer.test.ts`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 633</div>

- Primary file：`packages/agent/src/harness/reducer.ts`、`packages/agent/test/harness/reducer.test.ts`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 634 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 634</div>

- 根据已发现的 open start、有界 record 和通过 ID 点查得到的 entry，验证第 5 节的 corruption 规则；不执行写入或 effect。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 635 · list_item</div>

- Acceptance: one focused rejection test per validity bullet, plus valid prefixes at every section 6 crash point.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 635</div>

- 验收：每条有效性规则都有一个聚焦的拒绝测试，并覆盖第 6 节每个崩溃点上的有效前缀。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 636 · list_item</div>

- [x] **R2 — pure lane-state reduction.** Dependencies: R1.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 636</div>

- [x] **R2——纯 lane-state reduction。** 依赖：R1。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 637 · list_item</div>

- Primary files: `packages/agent/src/harness/reducer.ts`, `packages/agent/test/harness/reducer.test.ts`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 637</div>

- Primary file：`packages/agent/src/harness/reducer.ts`、`packages/agent/test/harness/reducer.test.ts`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 638 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 638</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 639 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 639</div>

- `LaneState` 只保留 orchestration 状态。Reduction 独占这三项输出的推导权；后续恢复包消费 `LaneReductionResult`，不得再次 reduction 工具或 operation record。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 640 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 640</div>

- 验收：表驱动测试覆盖 idle 与每一种 suspended 状态、配置 fallback/override 和 terminal-failure 来源；reduction 必须是确定性的，并且不执行写入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 641 · list_item</div>

- [ ] **R3 — harness restore inventory.** Dependencies: F0, R2.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 641</div>

- [ ] **R3——Harness restore 盘点。** 依赖：F0、R2。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 642 · list_item</div>

- Primary files: `packages/agent/src/harness/agent-harness.ts`, reducer integration helpers, and restore tests.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 642</div>

- Primary file：`packages/agent/src/harness/agent-harness.ts`、reducer 集成辅助函数和 restore 测试。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 643 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 643</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 644 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 644</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 645 · heading</div>

### Track J — JSONL storage

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 645</div>

### Track J——JSONL 存储

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 646 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 646</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 647 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 647</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 648 · list_item</div>

- [x] **J0 — JSONL metadata and codec contracts.** Dependencies: R0.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 648</div>

- [x] **J0——JSONL 元数据与 codec 契约。** 依赖：R0。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 649 · list_item</div>

- Primary files: JSONL type/codec modules and focused codec tests; no public repository export yet.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 649</div>

- Primary file：JSONL 类型／codec 模块及聚焦的 codec 测试；此时尚不导出公共 repository。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 650 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 650</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 651 · list_item</div>

- Acceptance: type and codec round trips cover every header field and line kind; no filesystem lifecycle yet.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 651</div>

- 验收：类型与 codec 往返测试覆盖每个 header 字段和 line kind；尚无文件系统生命周期。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 652 · list_item</div>

- [x] **J1 — format-4 per-session storage.** Dependencies: J0.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 652</div>

- [x] **J1——format-4 单 session 存储。** 依赖：J0。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 653 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 653</div>

- 为 entry、record、lane、fact、统计信息、branch query、operation-kind query 和 open-operation projection 实现单 session replay/write 支持。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 654 · list_item</div>

- Keep it internal; do not export a partially implemented repository.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 654</div>

- 保持内部使用；不要导出只完成一部分的 repository。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 655 · list_item</div>

- Acceptance: focused round-trip tests cover every mutation, shared `seq`, query bounds, immutable reads, and JSON validation.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 655</div>

- 验收：聚焦的往返测试覆盖每一种 mutation、共享 `seq`、查询边界、不可变读取和 JSON 验证。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 656 · list_item</div>

- [x] **J2 — format-4 repository lifecycle and forks.** Dependencies: J1.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 656</div>

- [x] **J2——format-4 repository 生命周期与 fork。** 依赖：J1。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 657 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 657</div>

- 加入 create/open/list/delete、每个 session 一条 writer queue、metadata 排序／过滤、branch/tree fork，以及具体的公共 `JsonlSessionRepo` 导出。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 658 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 658</div>

- 验收：完整的 backend-neutral conformance suite 在 JSONL 上通过，包括并发 lane 写入与 fork。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 659 · list_item</div>

- [x] **J3 — format-4 crash and corruption behavior.** Dependencies: J2.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 659</div>

- [x] **J3——format-4 崩溃与 corruption 行为。** 依赖：J2。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 660 · list_item</div>

- Add torn-tail truncation, malformed-interior rejection, missing-reference rejection, and lifecycle/concurrency edge cases.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 660</div>

- 加入 torn-tail 截断、malformed-interior 拒绝、missing-reference 拒绝，以及生命周期／并发边缘情况。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 661 · list_item</div>

- Acceptance: acknowledged writes survive reopen and malformed non-tail data is never silently repaired.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 661</div>

- 验收：已经确认的写入在 reopen 后仍然存在；位于非尾部的 malformed 数据绝不被静默修复。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 662 · list_item</div>

- [ ] **J4 — read-only v3 normalization.** Dependencies: J3.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 662</div>

- [ ] **J4——只读 v3 规范化。** 依赖：J3。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 663 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 663</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 664 · list_item</div>

- A read-only open must not modify the physical file. No coding-agent source or test is changed.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 664</div>

- 只读 open 不得修改物理文件。不得修改 coding-agent 源码或测试。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 665 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 665</div>

- 验收：fixture 测试覆盖第 12 节的每条规范化规则，包括 `fromHook` 为 true、false，以及 v3 缺失该值时规范化为 false，还包括 malformed v3 输入。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 666 · list_item</div>

- [ ] **J5 — first-write v3 conversion.** Dependencies: J4.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 666</div>

- [ ] **J5——首次写入时转换 v3。** 依赖：J4。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 667 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 667</div>

- 第一次 mutation 时通过临时 format-4 文件重写，保留 metadata/fact/tree 和已经解析或 legacy 的 parent 链接，并加入聚合的 v3 usage adjustment。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 668 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 668</div>

- 验收：崩溃安全转换测试覆盖 rename 前失败、成功 reopen、统计信息保持、无法解析的 legacy parent path，以及不会执行第二次转换。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 669 · list_item</div>

- [ ] **J6 — schema-based durable payload validation.** Dependencies: J5.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 669</div>

- [ ] **J6——基于 schema 的持久化 payload 验证。** 依赖：J5。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 670 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 670</div>

- 为 format-4 JSON 定义共享 TypeBox schema，并从中推导 session 类型；还要支持为应用自定义的 `AgentMessage` variant 注册 runtime schema。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 671 · list_item</div>

- Acceptance: malformed durable payloads are rejected consistently and JSONL decoding uses the shared schemas.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 671</div>

- 验收：malformed 的持久化 payload 会被一致拒绝，并且 JSONL 解码使用这些共享 schema。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 672 · heading</div>

### Track I — primitives

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 672</div>

### Track I——原语

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 673 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 673</div>

I0、I1、I2 可以彼此独立推进。I3 → I4 → I5 必须串行，并且要在 R2 固定 `LaneState` 形态后才开始。这些工作包使用独立模块和聚焦单元测试；I5 仍只实现原语，不修改 `agent-harness.ts`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 674 · list_item</div>

- [x] **I0 — telemetry contracts, typed schemas, and no-op context.** Dependencies: none.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 674</div>

- [x] **I0——telemetry 契约、类型化 schema 与 no-op context。** 依赖：无。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 675 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 675</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 676 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 676</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 677 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 677</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 678 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 678</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 679 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 679</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 680 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 680</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 681 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 681</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 682 · list_item</div>

- [ ] **I1 — hook registry and runner.** Dependencies: none.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 682</div>

- [ ] **I1——hook registry 与 runner。** 依赖：无。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 683 · list_item</div>

- Primary files: `packages/agent/src/harness/hooks.ts`, `packages/agent/test/harness/hooks.test.ts`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 683</div>

- Primary file：`packages/agent/src/harness/hooks.ts`、`packages/agent/test/harness/hooks.test.ts`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 684 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 684</div>

- 实现类型化注册、稳定 ID 验证、有序聚合、错误隔离、fail-closed `before_tool`，以及按 ID 保存的 resume data。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 685 · list_item</div>

- Acceptance: focused tests cover every section 11 aggregation and failure rule; no operation wiring yet.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 685</div>

- 验收：聚焦测试覆盖第 11 节的每一条聚合与失败规则；此时尚不接入 operation。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 686 · paragraph</div>

**Reserved: I2 by @vegarsti.**

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 686</div>

**Reserved: I2 by @vegarsti.**

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 687 · list_item</div>

- [ ] **I2 — passive events and watch buffering.** Dependencies: none.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 687</div>

- [ ] **I2——被动 event 与 watch buffering。** 依赖：无。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 688 · list_item</div>

- Primary files: `packages/agent/src/harness/events.ts`, `packages/agent/test/harness/events.test.ts`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 688</div>

- Primary file：`packages/agent/src/harness/events.ts`、`packages/agent/test/harness/events.test.ts`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 689 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 689</div>

- 实现被动 listener 隔离，以及 lane/session watcher 使用的 snapshot/start/unsubscribe buffer 原语。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 690 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 690</div>

- 验收：snapshot 与 event 之间没有空隙；按顺序只 flush 一次；watcher 相互独立；`handler_error` 递归安全；此时尚不接入 operation。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 691 · list_item</div>

- [ ] **I3 — lane mutation line.** Dependencies: R2.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 691</div>

- [ ] **I3——lane mutation line。** 依赖：R2。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 692 · list_item</div>

- Primary files: `packages/agent/src/harness/lane-runtime.ts`, focused mutation-line tests.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 692</div>

- Primary file：`packages/agent/src/harness/lane-runtime.ts` 及聚焦的 mutation-line 测试。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 693 · list_item</div>

- Implement the per-lane FIFO and state-update discipline with test-only jobs for every conditional history in section 15.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 693</div>

- 实现每条 lane 的 FIFO 与状态更新纪律，并用仅供测试的 job 覆盖第 15 节的每一条条件历史。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 694 · list_item</div>

- Acceptance: jobs never interleave, rejected jobs do not poison the queue, and no external effect runs inside a job.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 694</div>

- 验收：job 绝不交错；被 reject 的 job 不会污染 queue；任何外部 effect 都不会在 job 内执行。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 695 · list_item</div>

- [ ] **I4 — automatic `Effects` implementation.** Dependencies: I0, I1, I3, L3.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 695</div>

- [ ] **I4——自动 `Effects` 实现。** 依赖：I0、I1、I3、L3。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 696 · list_item</div>

- Primary files: `packages/agent/src/harness/effects.ts`, focused effects tests.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 696</div>

- Primary file：`packages/agent/src/harness/effects.ts` 及聚焦的 effects 测试。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 697 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 697</div>

- 在完整 `Effects` 接口后实现持久化写入、条件提交、Provider/tool/hook adapter、sleep、fault 传播和 live-state 更新。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 698 · list_item</div>

- Acceptance: every external effect and durable write crosses `Effects`, and a failed write faults the whole harness.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 698</div>

- 验收：每个外部 effect 与持久化写入都经过 `Effects`；写入失败会使整个 Harness fault。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 699 · list_item</div>

- [ ] **I5 — manual gate primitive.** Dependencies: I4.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 699</div>

- [ ] **I5——manual gate 原语。** 依赖：I4。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 700 · list_item</div>

- Primary files: `packages/agent/src/harness/gated-effects.ts`, focused gate tests.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 700</div>

- Primary file：`packages/agent/src/harness/gated-effects.ts` 及聚焦的 gate 测试。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 701 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 701</div>

- 实现 `GatedEffects` action 描述、稳定 peek、恰好释放一次、可重入嵌套 action、run-through 和 parked reject，但此时尚不接入公共 lane 控制。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 702 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 702</div>

- 验收：parked 期间 effect 为零；嵌套 hook action 能够出现，且不会与已释放 parent 形成死锁；持久化前缀 close 模拟在原语边界通过。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 703 · heading</div>

### Track L — agent-loop building blocks

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 703</div>

### Track L——Agent loop 构建块

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 704 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 704</div>

这些工作包都拥有 `packages/agent/src/agent-loop.ts`，因此必须严格按 L1 → L2 → L3 合并。每个工作包完成后，现有 `agent-loop` 与 `agent` 测试都应无需修改即可通过。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 705 · paragraph</div>

**Reserved: L1 by @cristinaponcela.** Other agents must not pick L1 while this ownership marker remains.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 705</div>

**Reserved: L1 by @cristinaponcela.** 只要这条 ownership marker 仍然存在，其他 Agent 就不得选择 L1。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 706 · list_item</div>

- [ ] **L1 — extract assistant streaming.** Dependencies: I0.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 706</div>

- [ ] **L1——提取 assistant streaming。** 依赖：I0。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 707 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 707</div>

- 加入 `streamAssistant()` 与 `StreamAssistantConfig`，包括显式 telemetry context；让兼容 loop 的请求路径经过它，但不改变 event 或结果。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 708 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 708</div>

- 验收：聚焦 stream 测试覆盖 settled-result narrowing（最终值为 `pending` 属于缺陷），且现有 loop 测试保持不变。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 709 · list_item</div>

- [ ] **L2 — extract tool-call phases.** Dependencies: L1.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 709</div>

- [ ] **L2——提取工具调用阶段。** 依赖：L1。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 710 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 710</div>

- 加入 `prepareToolCall()`、`executeToolCall()`、`finalizeToolCall()`、结果辅助函数、replay 声明、显式 telemetry context 和 durability callback，但不改变批次行为。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 711 · list_item</div>

- Acceptance: phase tests cover validation, blocking, abort, callback failure, updates, and patches.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 711</div>

- 验收：阶段测试覆盖 validation、blocking、abort、callback 失败、update 和 patch。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 712 · list_item</div>

- [ ] **L3 — compose tool batches and compatibility wrappers.** Dependencies: L2.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 712</div>

- [ ] **L3——组合工具批次与兼容包装器。** 依赖：L2。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 713 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 713</div>

- 加入 `executeToolBatch()`，实现 sequential/parallel 源码顺序、截断、abort 与 `terminate` 规则；让每个 legacy loop export 都成为使用 no-op context 的薄组合层。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 714 · list_item</div>

- Acceptance: source-order and parallelism tests plus unchanged `agent-loop` and `agent` suites.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 714</div>

- 验收：源码顺序与并行性测试通过，且现有 `agent-loop` 与 `agent` 测试保持不变。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 715 · heading</div>

### Track H — harness integration and run execution

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 715</div>

### Track H——Harness 集成与 run 执行

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 716 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 716</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 717 · list_item</div>

- [ ] **H0 — lane facades and primitive integration.** Dependencies: R3, I2, I5.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 717</div>

- [ ] **H0——lane facade 与原语集成。** 依赖：R3、I2、I5。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 718 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 718</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 719 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 719</div>

- 验收：重复获取的 facade 等价；lane 保持隔离；公共 drive 控制与 gate action 匹配；不会意外启用任何占位 operation。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 720 · list_item</div>

- [ ] **H1 — one successful no-tool run.** Dependencies: H0, L3, I1.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 720</div>

- [ ] **H1——一次成功且无工具的 run。** 依赖：H0、L3、I1。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 721 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 721</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 722 · list_item</div>

- H3 later owns public next-run enqueue/cancel/race behavior; H1 owns capture into `operation_started.initialMessages`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 722</div>

- H3 后续负责公共 next-run enqueue/cancel/race 行为；H1 负责把现有项目捕获进 `operation_started.initialMessages`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 723 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 723</div>

- 验收：automatic/manual 的持久化 log 完全相同；在每个已释放 action 后 close，都能 restore 出预期的 suspended 前缀。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 724 · list_item</div>

- [ ] **H2 — retry, run resume, and terminal failure.** Dependencies: H1.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 724</div>

- [ ] **H2——重试、run resume 与终止失败。** 依赖：H1。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 725 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 725</div>

- 加入持久化 attempt 计数、重试 policy/backoff/event、未完成 assistant resume、放弃时的错误 entry、终止失败 drain，以及这些状态的 fixed-point 检查。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 726 · list_item</div>

- Acceptance: retry caps survive reopen; failed attempts record usage but no message; half-completed recovery is idempotent.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 726</div>

- 验收：重试上限能跨 reopen 保持；失败 attempt 记录 usage 但不写消息；完成一半的恢复具有幂等性。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 727 · list_item</div>

- [ ] **H3 — queues and checkpoints.** Dependencies: H2.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 727</div>

- [ ] **H3——queue 与 checkpoint。** 依赖：H2。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 728 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 728</div>

- 加入 next-run/steer/follow-up 的准入与模式、取消、checkpoint 消费、queue event，以及结束边界条件操作。只消费 R2 产出的 queue 状态。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 729 · list_item</div>

- Acceptance: both orders of race rows 2, 5, 7, and 12; provider context grows only at the tail.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 729</div>

- 验收：race row 2、5、7、12 的两种顺序全部覆盖；Provider context 只在尾部增长。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 730 · list_item</div>

- [ ] **H4 — deferred writes, persisted configuration, and adjustments.** Dependencies: H3.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 730</div>

- [ ] **H4——deferred 写入、持久化配置与 adjustment。** 依赖：H3。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 731 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 731</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 732 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 732</div>

- 验收：race row 3、9 的两种顺序全部覆盖；已接受写入能跨崩溃与 abort marker 存活；adjustment 影响 ledger 总计，但绝不修改 entry。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 733 · list_item</div>

- [ ] **H5 — abort, wait, run-when-idle, and close.** Dependencies: H4.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 733</div>

- [ ] **H5——abort、wait、run-when-idle 与 close。** 依赖：H4。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 734 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 734</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 735 · list_item</div>

- Acceptance: both orders of race rows 4, 6, 8, and 10 and crash/reopen after every abort action.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 735</div>

- 验收：race row 4、6、8、10 的两种顺序，以及每个 abort action 后的 crash/reopen 全部覆盖。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 736 · list_item</div>

- [ ] **H6 — live durable tool batches.** Dependencies: H5.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 736</div>

- [ ] **H6——实时持久化工具批次。** 依赖：H5。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 737 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 737</div>

- 通过 `Effects` 接入第 14 节的工具 callback；执行前写入 `tool_started`，持久化最终结果与 `terminate`，报告 usage，并发送 tool event。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 738 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 738</div>

- 验收：单工具和并行批次的 trace 精确匹配；blocked/invalid 工具不写 intent；按源码顺序最终化的结果稳定。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 739 · list_item</div>

- [ ] **H7 — tool recovery.** Dependencies: H6.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 739</div>

- [ ] **H7——工具恢复。** 依赖：H6。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 740 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 740</div>

- 消费 R2 已归约的 X1–X5 状态并完成收敛；只有持久化声明和当前声明都为 safe 时才 replay；保留 ordinal；处理截断批次时不得执行。不要复制 reducer 逻辑。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 741 · list_item</div>

- Acceptance: complete tool crash matrix, changed replay declarations, parallel-prefix crashes, and idempotent second recovery.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 741</div>

- 验收：完整工具崩溃矩阵、变更后的 replay 声明、并行前缀崩溃，以及第二次恢复的幂等性全部覆盖。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 742 · list_item</div>

- [ ] **H8 — deferred provider redemption.** Dependencies: H7.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 742</div>

- [ ] **H8——deferred Provider 兑现。** 依赖：H7。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 743 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 745</div>

- 验收：每次 resume 只 fetch 一次；pending 除了已报告 usage 外不写任何内容；terminal error 绝不启动替代请求。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 746 · heading</div>

### Track C/N — structural operations

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 746</div>

### Track C/N——结构性操作

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 747 · paragraph</div>

These packages also own `agent-harness.ts` and merge after H8, in order C1 → C2 → C3 → N1.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 747</div>

这些工作包同样拥有 `agent-harness.ts`，并在 H8 之后按 C1 → C2 → C3 → N1 的顺序合并。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 748 · list_item</div>

- [ ] **C1 — manual compaction operation.** Dependencies: H8.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 748</div>

- [ ] **C1——手动 compaction operation。** 依赖：H8。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 749 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 749</div>

- 加入准入、hook 决策、持久化摘要 attempt/usage、完整 `retainedTail`、结果 entry、abort/failure 和 structural resume。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 750 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 750</div>

- 验收：精确匹配手动压缩 trace 和每个崩溃边界；hook 提供的摘要遵守同一份持久化 entry 契约，并持久化 `fromHook: true`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 751 · list_item</div>

- [ ] **C2 — threshold auto-compaction.** Dependencies: C1, H4.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 751</div>

- [ ] **C2——threshold 自动压缩。** 依赖：C1、H4。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 752 · list_item</div>

- Run compaction inside the active run at checkpoints without a nested operation and continue the assistant loop.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 752</div>

- 在 checkpoint 处、active run 内执行压缩，不创建嵌套 operation，然后继续 assistant loop。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 753 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 753</div>

- 验收：除压缩边界外，append-only context 不变量始终成立；重复压缩保留前一个 checkpoint tail。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 754 · list_item</div>

- [ ] **C3 — overflow recovery.** Dependencies: C2, H2.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 754</div>

- [ ] **C3——overflow 恢复。** 依赖：C2、H2。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 755 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 755</div>

- 对可恢复 overflow/length 结果分类；记录 usage 后丢弃结果；执行压缩；每次会话输入只重试一次；在有限步骤内失败。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 756 · list_item</div>

- Acceptance: every provider shape and crash row from sections 6 and 20, including hook decline and `length → length`.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 756</div>

- 验收：覆盖第 6、20 节的每种 Provider 形态和崩溃行，包括 hook decline 与 `length → length`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 757 · list_item</div>

- [ ] **N1 — move-first navigation.** Dependencies: C3.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 757</div>

- [ ] **N1——move-first 导航。** 依赖：C3。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 758 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 758</div>

- 加入准入、放弃分支的 preparation、hook/生成摘要、move 提交、move 后摘要／fact 写入、abort/failure 和 structural resume。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 759 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 759</div>

- 验收：覆盖每条导航崩溃行，包括 move 后崩溃的重新生成，以及 target/source 验证；hook 提供的摘要持久化 `fromHook: true`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 760 · heading</div>

### Track O — observability and core completion

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 760</div>

### Track O——可观测性与核心收尾

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 761 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 761</div>

这些工作包在 N1 后按 O1 → O2 → O3 → O4 合并，QA3 位于 O2 与 O3 之间。QA3 还依赖 J6。它们不得修改 `packages/coding-agent/**`。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 762 · list_item</div>

- [ ] **O1 — snapshots and event completeness.** Dependencies: N1, I2.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 762</div>

- [ ] **O1——snapshot 与 event 完整性。** 依赖：N1、I2。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 763 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 763</div>

- 完成 live lane/session snapshot、event 过滤、streaming/running-tool 状态，以及第 10 节的全部 event 插入点。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 764 · list_item</div>

- Acceptance: event nesting/order tests and attach-mid-operation snapshot tests with no subscription gap.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 764</div>

- 验收：event 嵌套／顺序测试和 operation 中途 attach 的 snapshot 测试通过，且不存在订阅空隙。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 765 · list_item</div>

- [ ] **O2 — runtime telemetry instrumentation.** Dependencies: O1, I0.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 765</div>

- [ ] **O2——runtime telemetry instrumentation。** 依赖：O1、I0。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 766 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 766</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 767 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 767</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 768 · list_item</div>

- [ ] **O3 — action-prefix and race audit.** Dependencies: O2, QA3.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 768</div>

- [ ] **O3——action-prefix 与 race 审计。** 依赖：O2、QA3。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 769 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 769</div>

- 为每个 race row 完成 Tier C；以机械方式重新打开每一个 action 前缀；比较 automatic/manual log；验证 reducer/live-state fixed point。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 770 · list_item</div>

- Acceptance: every race row has both orders and no documented crash action lacks a reopen test.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 770</div>

- 验收：每个 race row 都有两种顺序，且每个文档列出的崩溃 action 都有 reopen 测试。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 771 · list_item</div>

- [ ] **O4 — backend parity and final core audit.** Dependencies: J6, O3.

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 771</div>

- [ ] **O4——后端 parity 与最终核心审计。** 依赖：J6、O3。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 772 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 772</div>

- 在 memory、JSONL、SQLite 上运行完整存储／恢复矩阵；删除失效的 Agent/storage 声明与兼容注释；验证 export/declaration 与 `./node`；更新 changelog 和核心文档。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 773 · list_item</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 773</div>

- 验收：所有非 e2e 测试与 `npm run check` 通过；active Harness operation 中不再存在 scaffold；`packages/coding-agent/**` 保持不变；worktree 干净。

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 774 · heading</div>

### Dependency, priority, and merge summary

<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 774</div>

### 依赖、优先级与合并顺序

<div class="bilingual-divider"></div>

<div class="bilingual-marker bilingual-marker-en">English original · 775 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 775</div>
...
<div class="bilingual-marker bilingual-marker-en">English original · 776 · paragraph</div>
...
<div class="bilingual-marker bilingual-marker-zh">中文翻译 · 776</div>
